function [] = plotMapInTime(M,fig_dim,number_of_levels,l_colb,map_color,colorbounds,big_title,p)
lat = p.lat;
lon = p.lon;
ww = p.ww;
...
hold off 
% view(2)
title(["Y"+ int2str(i) + ", Avg: " + T_average + " " + p.units])
...
hl = colorbar('YTick',v,'Location','eastoutside');
sgtitle(big_title);
end